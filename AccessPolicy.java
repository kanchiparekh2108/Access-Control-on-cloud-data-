...
public class AccessPolicy {
	...
	public static Target createPolicyTarget() throws URISyntaxException {
		...
		StringAttribute subjectValue = new StringAttribute("company.com");
		...
		AnyURIAttribute resourceValue =
			new AnyURIAttribute(
				new URI("file:///D:/Documents/Administrator/Desktop/Project_Plan.html"));
	...
	public static Apply createRuleCondition() throws URISyntaxException {
		...
		StringAttribute value = new StringAttribute("Intern");
	...
	public static List createRules() throws URISyntaxException {
		...
		URI ruleId = new URI("ProjectPlanAccessPolicy");
	...
	public static void main(String[] args) throws Exception {
		...
		String description =
			"This AccessPolicy applies to any account at secf.com "
				+ "accessing file:///D:/Documents/Administrator/Desktop/Project_Plan.html.";
		...
		OutputStream out = new FileOutputStream("/Users/kanch/eclipse-workspace/org.eklavya.accesscontro/deny.xml");
